...
Route::prefix('print')->name('api.print.')->middleware('agente.impressao')->group(function () {
    ...
    Route::get('/impressoras', [PrintController::class, 'listarImpressoras'])->name('impressoras');
});

// Rota específica para o agente de impressão (compatibilidade)
Route::get('/cupom-parcial/{pedidoId}', [PrintController::class, 'getPedidoForPrint'])->middleware('agente.impressao')->name('api.cupom-parcial');
