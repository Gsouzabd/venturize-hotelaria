...
<div class="tab-pane fade" id="consumo" role="tabpanel" aria-labelledby="consumo-tab">
                            ...
                            <ul class="list-group">
                                @foreach($produtos as $produto)
                                    <li class="list-group-item">
                                        <button class="btn btn-link produto-to-add-consumo" data-produto-id="{{ $produto->id }}" data-produto-descricao="{{ $produto->descricao }}" data-produto-preco="{{ $produto->preco_venda }}">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            document.querySelectorAll('.produto-to-add-consumo').forEach(button => {
                button.addEventListener('click', function () {
